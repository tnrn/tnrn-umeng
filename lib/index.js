...
const PushEmitter = new NativeEventEmitter(RNUmengPush);
...
export default class UMPush {
  ...
  static receiveNotification(callback = () => { }) {
    return PushEmitter.addListener('appDidReceiveRemoteNotification', callback)
  }

  // 点击推送消息 打开App
  static openNotification(callback = () => { }) {
    return PushEmitter.addListener('appDidOpenRemoteNotification', callback)
  }
